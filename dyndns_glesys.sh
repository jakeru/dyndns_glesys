...
# Asks the EdgeRouter the IP address of eth0 and uses the GleSYS API to
# update a A record to point to this IPv4 address.
# Written by Jakob Ruhe 2018-03-19.

# Origin:
# https://github.com/jakeru/dyndns_glesys
# License: MIT License
# Copyright (C) 2018 Jakob Ruhe.
...
# the first /.
my_address=$($show_interfaces | grep -E ^eth0 | awk -F " " '{print $2}' | cut -d '/' -f 1)
